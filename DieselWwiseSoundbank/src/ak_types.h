...
namespace Wwise {
    ...
    enum class PluginID : uint32_t {
        ...
        OPUS_WEM,
        SONY360 = 0x00160001,
        Wwise_Sine = 0x00640002,
        Wwise_Silence,
        Wwise_Tone_Generator,
        Wwise_Unknown_00670003 = 0x00670003,
        Wwise_Unknown_00680003,
        Wwise_Parametric_EQ,
        Wwise_Delay,
        Wwise_Compressor = 0x006C0003,
        Wwise_Expander,
        Wwise_Peak_Limiter,
        Wwise_Unknown_006F0003,
        Wwise_Unknown_00700003,
        Wwise_Matrix_Reverb = 0x00730003,
        SoundSeed_Impact,
        Wwise_RoomVerb = 0x00760003,
        SoundSeed_Air_Wind = 0x00770002,
        SoundSeed_Air_Woosh,
        Wwise_Flanger = 0x007D0003,
        Wwise_Guitar_Distortion,
        Wwise_Convolution_Reverb,
        Wwise_Meter = 0x00810003,
        Wwise_Time_Stretch,
        Wwise_Tremolo,
        Wwise_Recorder,
        Wwise_Stereo_Delay = 0x00870003,
        Wwise_Pitch_Shifter,
        Wwise_Harmonizer = 0x008A0003,
        Wwise_Gain,
        Wwise_Synth_One = 0x00940002,
        Wwise_Reflect = 0x00AB0003,
        System = 0x00AE0007, // AudioDevice of the same name
        Communication = 0x00B00007,
        Controller_Headphones,
        Controller_Speaker = 0x00B30007,
        No_Output = 0x00B50007, // AudioDevice of the same name
        SoundSeed_Grain = 0x00B70002,
        Mastering_Suite = 0x00BA0003,
        Wwise_3D_Audio_Bed_Mixer = 0x00BE0003,
        Wwise_Audio_Input = 0x00C80002,
        Wwise_Motion_Generator = 0x01950002,
        Wwise_Motion_Generator_Feedback = 0x01950005,
        Wwise_Motion_Source = 0x01990002,
        Wwise_Motion_Source_Feedback = 0x01990005,
        Wwise_Motion_Unknown = 0x01FB0007,
        Wwise_System_Output_Settings = 0x03840009,
        Auro_Headphone = 0x044C1073,
        McDSP_ML1 = 0x00671003,
        McDSP_FutzBox = 0x006E1003,
        iZotope_Hybrid_Reverb = 0x00021033,
        iZotope_Trash_Distortion,
        iZotope_Trash_Delay,
        iZotope_Trash_Dynamics_Mono,
        iZotope_Trash_Filters,
        iZotope_Trash_Box_Modeler,
        iZotope_Trash_Multiband_Distortion = 0x00091033,
        Platinum_MatrixSurroundMk2 = 0x006E0403,
        Platinum_LoudnessMeter,
        Platinum_SpectrumViewer = 0x00710403,
        Platinum_EffectCollection,
        Platinum_MeterWithFilter,
        Platinum_Simple3D,
        Platinum_Upmixer,
        Platinum_Reflection,
        Platinum_Downmixer,
        Platinum_Flex,
        Microsoft_Spatial_Sound = 0x00AA1137,
        CPR_Simple_Delay = 0x000129A3,
        CPR_Voice_Broadcast_Receive_1 = 0x000229A2,
        CPR_Voice_Broadcast_Send_1 = 0x000329A3,
        CPR_Voice_Broadcast_Receive_2 = 0x000429A2,
        CPR_Voice_Broadcast_Send_2 = 0x000529A3,
        Crankcase_REV_Model_Player = 0x01A01052
    };
